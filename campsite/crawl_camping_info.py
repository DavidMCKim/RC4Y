            ...
            for campsite in campsites:
                try:
                    ...
                    if result == []:
                        ...
                        #         '''
                        value = f'''{scrap_data['Category']} / {scrap_data['CampSiteID']} / {scrap_data['CampSiteName']} / {scrap_data['RoadAddress']} / {scrap_data['Lotaddress']} / {scrap_data['Latitude']} / {scrap_data['Longitude']} / {scrap_data['PhoneNumber']} / {scrap_data['VirtualNumber']} / {scrap_data['siteUrl']} / {scrap_data['Facility']} / {scrap_data['ImageUrls']} / {scrap_data['UseFlag']} / CURRENT_TIMESTAMP()'''
